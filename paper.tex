...
We observe multiple brightenings in the pre-flare window (Fig. \ref{c4_lc}). All the brightening is occurring on the Polarity Inversion Line (PIL), and some are located close to it (fig \ref{fig:c4_hmi}). 
...
For three such events, we found a time delay of approximately 90 seconds between the HEL1OS signal and the \ion{Mg}{ii}~h response (DCF plot required).
