...
In this case, we also observe multiple brightenings in the pre-flare window. Four major brightening locations were identified, including flare locations (B1, B2, B3 and B4). 
...
SoLEXS temperature does not show much variation, fluctuating between 6-7 MK.
