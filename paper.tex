...
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{Figures/4case4_lc.eps}  
...
We observe multiple brightenings in the pre-flare window (Fig. \ref{c4_lc}). All the brightening is occurring on the Polarity Inversion Line (PIL), and some are located close to it. 
